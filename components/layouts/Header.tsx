...
export function Header() {
  return (
    <header className="fixed w-full flex justify-center items-center backdrop-saturate-[150%] bg-[#dfecdf]/33 backdrop-blur-[5px] border-b-2 shadow-sm border-[#bfd9bf] lg:px-6 lg:py-1">
