...
export function Header() {
  return (
    <header className="fixed w-full flex justify-center items-center backdrop-saturate-[150%] bg-white/60 backdrop-blur-[4px] z-50 border-b-[1px] shadow-sm border-black/30 lg:px-6 lg:py-1">
        ...
        <NavigationMenu>
          <NavigationMenuList>
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="flex flex-col gap-4 p-2 md:w-[400px] lg:w-[500px]">
                  <Link href="/" title="History" className="p-2 hover:bg-white/80 rounded-xl duration-100">
                  ...
                  <Link href="/" title="Benefits" className="p-2 hover:bg-white/80 rounded-xl duration-100">
                  ...
                  <Link href="/" title="Our Team" className="p-2 hover:bg-white/80 rounded-xl duration-100">
            ...
            <NavigationMenuItem>
              ...
              <NavigationMenuContent>
                <ul className="flex flex-col gap-4 p-2 md:w-[400px] lg:w-[500px]">
                  <Link href="/" title="Options" className="p-2 hover:bg-white/80 rounded-xl duration-100">
                  ...
                  <Link href="/" title="Pricing" className="p-2 hover:bg-white/80 rounded-xl duration-100">
                  ...
                  <Link href="/" title="Memberships" className="p-2 hover:bg-white/80 rounded-xl duration-100">
            ...
            <NavigationMenuItem className="hidden min-[320px]:flex">
              ...
              <NavigationMenuContent>
                <ul className="flex flex-col gap-4 p-2 md:w-[400px] lg:w-[500px]">
                  <Link href="/" title="Contact Us" className="p-2 hover:bg-white/80 rounded-xl duration-100">
                  ...
                  <Link href="/" title="FAQ" className="p-2 hover:bg-white/80 rounded-xl duration-100">
                    <div className="text-base lg:text-lg font-bold">FAQ</div>
                    <div className="text-xs lg:text-sm">Learn about the health benefits that saunas provide for body and mind.</div>
                  </Link>
                  <Link href="/" title="Reviews" className="p-2 hover:bg-white/80 rounded-xl duration-100">
