...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 text-base lg:text-lg text-foreground items-center justify-center rounded-md gap-1.5 md:gap-2 disabled:pointer-events-none disabled:opacity-50"
)
